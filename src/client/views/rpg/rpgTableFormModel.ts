import type { RpgTableDetails, RpgCreateTableBody, RpgUpdateTableBody } from '../../../types/api/rpg'
...
export function validateRpgTable(values: RpgTableFormValues): string | null {
  ...
  if (!Number.isInteger(values.maxPlayers) || values.maxPlayers < 1 || values.maxPlayers > 10) {
