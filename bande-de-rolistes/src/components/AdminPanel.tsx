...
import { apiAdminUsers, apiAdminRoles, apiAdminUpdateRole, type User, type Role } from '../authApi'
...
function AdminPanel() {
  ...
  async function loadData() {
    try {
      ...
      console.log('✅ Données chargées:', { usersCount: usersData.length, rolesCount: rolesData.length })
      setUsers(usersData)
      setRoles(rolesData)
    } catch (err) {
